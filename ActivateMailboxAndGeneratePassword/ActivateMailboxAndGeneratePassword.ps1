#============================================================================================================================================================================================================================================
# ActivateMailboxAndGeneratePassword v2.0 by Charlie Gustav Skog - https://github.com/GIH-IT/Scripts/blob/master/ActivateMailboxAndGeneratePassword/ActivateMailboxAndGeneratePassword.ps1
