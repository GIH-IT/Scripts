...
# Set script title.
$host.ui.RawUI.WindowTitle = "CreateStudentsAndMailboxes v1.0 by Charlie Gustav Skog"
...
$StudentDescription = "Created by script CreateStudentsAndMailboxes V1.0 run by " + $ScriptCredentials.UserName
...
# Set up PSSession to Exchange Server and import it.
